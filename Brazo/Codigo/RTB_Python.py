...
L2 = rtb.RevoluteDH(d = 0, a = l2, alpha = 0, offset = -np.pi/2); # Nota: el offset de -pi/2 se aplica para que el eslabón 2 tenga un ángulo de 90° respecto al eslabón 1
